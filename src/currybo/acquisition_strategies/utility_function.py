...
class QuantileUtility(BaseMCUtilityFunction):
    ...
    def __init__(self, beta: float = 5, maximize: bool = True):
...
class QuantitativeImprovement(BaseMCUtilityFunction):
    ...
    def __init__(self, best_f: float, maximize: bool = True):
...
class QualitativeImprovement(BaseMCUtilityFunction):
    ...
    def __init__(self, best_f: float, tau: float = 0.01, maximize: bool = True):
