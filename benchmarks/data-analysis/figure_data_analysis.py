...
def create_plot_all(first_element, second_element, third_element, fourth_element, fifth_element, sixth_element, seventh_element, eigth_element, file_name, generality_y = [0, 1], frac = False):
    ...
    with pub_ready_plots.get_context(
        ...
        height_frac=0.37,  # between 0 and 1
        ...
        axs[0, 0].errorbar(torch.arange(1, first_element.shape[1] + 1),
                    ...
                    capthick = 1.5,
                    marker=".",
                    label ="Pd-catalyzed carbon-heteroatom coupling"
        )
        ...
        axs[0, 0].set_title("Original Search Space", size=10)
        spearmanr = stats.spearmanr(torch.arange(1, first_element.shape[1] + 1), mean)
        texts = [axs[0, 0].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[0, 0].transAxes, fontsize=8, va='bottom', ha='center'), axs[0, 0].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[0, 0].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        axs[0, 1].set_title("Augmented Search Space", size=10)
        spearmanr = stats.spearmanr(torch.arange(1, second_element.shape[1] + 1), mean)
        texts = [axs[0, 1].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[0, 1].transAxes, fontsize=8, va='bottom', ha='center'), axs[0, 1].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[0, 1].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        texts = [axs[1, 0].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[1, 0].transAxes, fontsize=8, va='bottom', ha='center'), axs[1, 0].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[1, 0].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        mean = mean[~torch.isnan(mean)]
        spearmanr = stats.spearmanr(x, mean)
        texts = [axs[1, 1].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[1, 1].transAxes, fontsize=8, va='bottom', ha='center'), axs[1, 1].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[1, 1].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        axs[2, 0].set_xticks(ticks=range(0, fifth_element.shape[1] + 1, 2))
        axs[2, 0].set_xticks(range(0, fifth_element.shape[1] + 1, 1), minor=True)
        ...
        if frac:
            texts = [axs[2, 0].text(0.95, 0.85, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[2, 0].transAxes, fontsize=8, va='top', ha='center'), axs[2, 0].text(0.95, 0.65, rf"Max. score: {torch.max(mean):.2f}", transform=axs[2, 0].transAxes, fontsize=8, va='top', ha='center')]
        else:
            texts = [axs[2, 0].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[2, 0].transAxes, fontsize=8, va='bottom', ha='center'), axs[2, 0].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[2, 0].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        axs[2, 1].set_xticks(ticks=range(0, sixth_element.shape[1] + 1, 2))
        axs[2, 1].set_xticks(range(0, sixth_element.shape[1] + 1, 1), minor=True)
        ...
        if frac:
            texts = [axs[2, 1].text(0.95, 0.85, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[2, 1].transAxes, fontsize=8, va='top', ha='center'), axs[2, 1].text(0.95, 0.65, rf"Max. score: {torch.max(mean):.2f}", transform=axs[2, 1].transAxes, fontsize=8, va='top', ha='center')]
        else:
            texts = [axs[2, 1].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[2, 1].transAxes, fontsize=8, va='bottom', ha='center'), axs[2, 1].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[2, 1].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        axs[3, 0].set_xticks(ticks=range(0, seventh_element.shape[1] + 1, 2))
        axs[3, 0].set_xticks(range(0, seventh_element.shape[1] + 1, 1), minor=True)
        ...
        texts = [axs[3, 0].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[3, 0].transAxes, fontsize=8, va='bottom', ha='center'), axs[3, 0].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[3, 0].transAxes, fontsize=8, va='bottom', ha='center')]
        ...
        axs[3, 1].set_xticks(ticks=range(0, eigth_element.shape[1] + 1, 2))
        axs[3, 1].set_xticks(range(0, eigth_element.shape[1] + 1, 1), minor=True)
        ...
        texts = [axs[3, 1].text(0.95, 0.15, rf"Spearman's rho: {spearmanr.statistic:.2f}", transform=axs[3, 1].transAxes, fontsize=8, va='bottom', ha='center'), axs[3, 1].text(0.95, 0.05, rf"Max. score: {torch.max(mean):.2f}", transform=axs[3, 1].transAxes, fontsize=8, va='bottom', ha='center')]
...
def create_plot_method(first_element_random, first_element_fps, first_element_smart, second_element_random, second_element_fps, second_element_smart, file_name, generality_y = [0, 1]):
    ...
    with pub_ready_plots.get_context(
        width_frac=1,  # between 0 and 1
        height_frac=0.18,  # between 0 and 1
        layout="iclr",  # or "iclr", "neurips", "poster-portrait", "poster-landscape"
        single_col=False,  # only works for the "icml" layout
