...
def create_plot(first_element, second_element, third_element, fourth_element, MAX_BUDGET, file_name, gap=True):
    ...
    with pub_ready_plots.get_context(
        ...
        height_frac=0.3,  # between 0 and 1
        layout=pub_ready_plots.Layout.ICLR,  # or "iclr", "neurips", "poster-portrait", "poster-landscape"
        ...
        fig.legend(handles=handles, labels=labels, loc="outside lower center", ncol=3)
